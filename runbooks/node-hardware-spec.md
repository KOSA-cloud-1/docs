...
| ---- | ----: | ------------ | ------------- | ----------- | ---: | ------------: | -------------: |
| cp1  |  1001 | team12       | 172.17.128.21 | 10.10.10.51 |    4 | 8192 MB (8GB) |  4096 MB (4GB) |
| cp2  |  1002 | team13       | 172.17.128.22 | 10.10.10.52 |    4 | 8192 MB (8GB) |  4096 MB (4GB) |
| cp3  |  1003 | team14       | 172.17.128.23 | 10.10.10.53 |    4 | 8192 MB (8GB) |  4096 MB (4GB) |


# Worker Nodes
| Node    | VM ID | Proxmox Node | 1G IP         | 10G IP      | vCPU |      Max Memory | Balloon Memory |
| ------- | ----: | ------------ | ------------- | ----------- | ---: | --------------: | -------------: |
| worker1 |  1011 | team12       | 172.17.128.24 | 10.10.10.54 |    8 | 16384 MB (16GB) |  8192 MB (8GB) |
| worker2 |  1012 | team13       | 172.17.128.25 | 10.10.10.55 |    8 | 16384 MB (16GB) |  8192 MB (8GB) |
